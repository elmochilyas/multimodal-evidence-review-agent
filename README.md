...
<p align="center">
  <img src="docs/assets/hero.png" alt="README hero image" width="100%">
</p>
<p align="center"><em>A visual overview of the evidence review pipeline and structured decision workflow.</em></p>
...
<p align="center">
  <img src="docs/assets/workflow-placeholder.png" alt="Workflow diagram" width="850">
</p>
<p align="center"><em>Claim conversation + images + user history + requirements → evidence review agent → validated CSV decision.</em></p>

## Architecture

<p align="center">
  <img src="docs/assets/architecture-placeholder.png" alt="Architecture diagram" width="850">
</p>
<p align="center"><em>Input loading → claim extraction → image analysis → evidence check → risk flags → decision generation → validation → CSV export.</em></p>
...
<p align="center">
  <img src="docs/assets/output-card-placeholder.png" alt="Output decision card" width="850">
</p>
<p align="center"><em>Structured decision output with claim status, issue type, object part, severity, and grounded justification.</em></p>
